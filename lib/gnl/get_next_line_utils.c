...
/*   Updated: 2023/02/14 14:13:36 by acerrah          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*gnlft_strdup(const char *s1)
{
	...
	i = 0;
	str = (char *)malloc(sizeof(char) * (gnlft_strlen(s1) + 1));
	if (!str)
		return (NULL);
	while (s1[i] != '\0')
	{
...
char	*gnlft_strjoin(char *s1, char const *s2)
{
	...
	str = (char *)malloc(sizeof(char) * (gnlft_strlen(s1) + gnlft_strlen(s2) + 1));
	if (!str)
		return (NULL);
	while (s1[++i] != '\0')
		str[i] = s1[i];
